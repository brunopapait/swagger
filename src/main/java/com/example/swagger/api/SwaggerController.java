...
public class SwaggerController {
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "422", description = "Erro ao realizar o upload do arquivo!"),
      @ApiResponse(responseCode = "400", description = "Paramêtros inválidos!"),
      @ApiResponse(responseCode = "500", description = "Erro ao realizar o upload do arquivo!")
  })
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(responseCode = "422", description = "Erro ao realizar a busca dos dados!"),
      @ApiResponse(responseCode = "400", description = "Paramêtros inválidos!"),
